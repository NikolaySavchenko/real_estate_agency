# Generated by Django 2.2.24 on 2023-01-13 18:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('property', '0011_auto_20230113_2048'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flats', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='owners', to='property.Flat', verbose_name='Квартиры в собственности')),
            ],
        ),
    ]
